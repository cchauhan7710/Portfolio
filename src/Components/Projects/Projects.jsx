  ...
  return (
    <section id="projects" className="py-16 sm:py-24 bg-[var(--bg-primary)] relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex items-center justify-center gap-3 mb-8 sm:mb-10 px-2">
          <div className="p-1 sm:p-1.5 rounded-2xl bg-[var(--bg-secondary)] border border-[var(--glass-border)] flex items-center gap-1 sm:gap-1.5 shadow-xl max-w-full">
            <button
              onClick={() => setViewMode("browser")}
              className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-bold transition-all whitespace-nowrap ${
                viewMode === "browser"
